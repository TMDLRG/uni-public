...
lens_schema: 1
scope: wiki
key: minecraft/release-readiness
corpus: minecraft
source_sha256: 1df05947f23e98d8
source_body_sha256: 968c17e9b2ee9cb0
source_title: RELEASE READINESS — worldwide broadcast go/no-go (2026-07-11)
source_words: 1082
...
A short section lists what is genuinely ready. Then twelve blockers, ranked by how badly each would hurt on the night: no working control surface for the intended path, no programme to broadcast, a safety-critical refusal property with code but no captured evidence, no fallback content, no cleared music, no emergency stop, a single point of failure, contradictory language lists, unproven encoding, a self-check that is empty, an undeployed guest path, and no alerting.
