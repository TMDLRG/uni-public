...
lens_schema: 1
scope: wiki
key: minecraft/lab-team-02-aif-core-theorist
corpus: minecraft
source_sha256: 834e8645c207660d
source_body_sha256: 834e8645c207660d
source_title: Lab Team — The AIF Core Theorist
source_words: 504
...
The required checks ask that the proposal name its generative model explicitly, that every new quantity map to a recognised slot, that a claim fence appear in both the document and the code path so that beliefs are never narrated as feelings, and that the final verdict cite each role's contribution.
