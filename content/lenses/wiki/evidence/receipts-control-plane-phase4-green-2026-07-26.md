...
<!--CLEAR-->
A green receipt — the file recording what was run — with the counts before and after, and a note that the test count is identical across red and green, which is what makes the comparison mean anything.
