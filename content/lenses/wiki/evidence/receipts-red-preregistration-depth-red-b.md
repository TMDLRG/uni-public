...
<!--CLEAR-->
No result has been recorded here at all. It is a pre-registration: the test, the pass condition and the falsifier, all committed to paper before the run, with the verdict withheld.
