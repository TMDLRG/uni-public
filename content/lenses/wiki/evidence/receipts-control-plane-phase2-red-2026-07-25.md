...
A short closing list records what did not move: no dependency added, no canonical ledger written, a user-owned file untouched, no verdict authored and no gate row appended.
