...
lens_schema: 1
scope: wiki
key: encyclopedia/wing-s-s-l1-cellular
corpus: encyclopedia
source_sha256: e0ee5adbddd74f7a
source_body_sha256: e0ee5adbddd74f7a
source_title: S-L1 - Cellular: the Cell Lab (with its honest losses)
source_words: 1440
...
What the rung is not is stated as carefully: not sovereign control, not autonomy, not life, not a cell that maintains itself in the world. The falsifier runs both ways, since the win falls if the interval fails to separate where a win is claimed, and each recorded loss falls if it fails to replicate.
