...
lens_schema: 1
scope: wiki
key: encyclopedia/wing-s-s-l7-language
corpus: encyclopedia
source_sha256: 5124249d333ba6a8
source_body_sha256: 5124249d333ba6a8
source_title: S-L7 - Language: Phase J specialist PASS and the central wall
source_words: 1742
...
Language is where the program earned one narrow pass and then ran into a wall. The pass is a specialist reader for rare words and word structure, which beats a strong count baseline by a measured margin on sealed text. It never travels alone, because the same ledger records that the specialist gain costs overall fluency, so the score across the whole distribution gets worse. Around that single result sit the bounds. Comprehension beyond retrieval is a published negative recorded three times over, not a quiet failure. Two further attempts fell over under measurement, and one of them had first been talked into a cheaper shortcut that the experiment then disproved. The broad perplexity frontier is parked and not claimed. All of it belongs to a developmental active-inference simulation, a bounded peek at a toy world and never a person.
...
The hardest thing asked of the reader is comprehension that cannot be solved by recency or frequency lookups, and that is the central wall: several structurally distinct designs all fail to beat retrieval-style baselines on adversarial comprehension. The framing is strict, being a ledger-scoped, implementation-scoped, split-scoped negative over the tested envelope only, not a universal impossibility and not an achieved rung, with a licensed wording that replaces any claim of exhaustion.
