...
lens_schema: 1
scope: wiki
key: encyclopedia/wing-natura-na-06-frequencies-rhythm-and-resonance
corpus: encyclopedia
source_sha256: adb2cd084aad0441
source_body_sha256: adb2cd084aad0441
source_title: NA-06 — The frequencies: rhythm, resonance, and the honest fence around them
source_words: 5259
...
The rest of the chapter carries measured biological rates alongside the frequencies people attach unearned claims to, with the inadmissible ones recorded with their receipts rather than mocked. One distinction there is worth keeping: an unfalsifiable claim has not lost the argument, it has declined to play, and the fence sits on the claim's form rather than on the person holding it.

The chapter's own class is contested, and chosen deliberately: its spine has several live disputes in it, and a chapter with that many disputes is contested rather than settled. Its closing list says what none of it does. Nothing in the programme's own ledger moves because a paper was cited here, and any prose that lets a citation imply a capability has crossed a lane and is defective.
