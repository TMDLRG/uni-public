...
lens_schema: 1
scope: wiki
key: encyclopedia/wing-mu-mu1-evidence-constitution
corpus: encyclopedia
source_sha256: b5d7e75d235a5b7d
source_body_sha256: b5d7e75d235a5b7d
source_title: mu1 - The Evidence Constitution and ledger discipline
source_words: 1545
...
A rule, not a result, and the chapter says as much in its opening line. The program it governs is a developmental active-inference simulation, a bounded peek into a toy world and never a person. Before anyone can honestly say a step has been earned, there has to be a rule for what earned means, who decides, and how a claim is allowed to move. That is what this chapter fixes, and it asserts no capability. If you read a claim that the program has a constitution as a claim that the program works, you have already broken the first rule it sets. There is one append-only ledger, every claim lives there in exactly one of four states with an evidence class and a falsifier, and a claim asserted ahead of its row is not permitted. Wording is only ever calibrated down toward what was measured. Corrections supersede a row with lineage rather than editing it. And where the prose and the ledger disagree, the ledger wins and the prose is wrong.
