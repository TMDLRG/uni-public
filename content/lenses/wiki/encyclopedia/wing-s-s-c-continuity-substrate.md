...
lens_schema: 1
scope: wiki
key: encyclopedia/wing-s-s-c-continuity-substrate
corpus: encyclopedia
source_sha256: b884ed404697a421
source_body_sha256: b884ed404697a421
source_title: S-C - Continuity and the embodiment substrate (UNI.OS)
source_words: 2759
...
The remaining sections describe a gated action surface in which the operator approves or declines and every verdict updates a persistent prior, a single-approval route for cross-machine changes, isolation primitives shown under inspection rather than as held gates, and a set of honest trades and open gaps, including the central one, that the live system does not yet run the primitives that earned the science gates.
