...
lens_schema: 1
scope: wiki
key: cookbook/recipes-l2-metabolism
corpus: cookbook
source_sha256: 21346fa3663ec72b
source_body_sha256: 21346fa3663ec72b
source_title: L2 — Tissue / metabolism (interoception and energy)
source_words: 2047
...
The last section is a signed consultation design for the smallest cure: one additional hidden factor about where a block could usefully go next, plus one policy term valuing information gain about it, with its weight set by matching rather than by hand-waving. A paired experiment is designed around it with required ablations that must collapse the gain, and a falsifier list that includes the possibility that the sharpening explanation was right all along. The status is stated plainly: designed and not run, raising nothing, with the gate still open.

The closing fence carries both halves together: proven as a foraging and crafting driver, negative as a building driver, with the cure designed only.
