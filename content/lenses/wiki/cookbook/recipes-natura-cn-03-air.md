...
Along the way it does the derivations. It works out how thick the atmosphere is from first principles. It treats sound, including how absorption depends on frequency and humidity. The tidy rule people quote fails in real air at everyday frequencies, because relaxation in the molecules takes over. The receipt shows the measured change falling far short of what the rule demands, and a humidity dependence that rises then falls, which no such rule can produce. It treats light, and gives the sky's colour as its cleanest example of a correct law giving a wrong answer through a dropped term. It treats the atmosphere as a heat engine and gets a dimensionless payoff out of it. It notes that the oxygen content has a history rather than being a constant.
